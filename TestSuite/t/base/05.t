...
expect("CreateFile %s 2 0 0 TRUNCATE_EXISTING 0 0" % name, "ERROR_INVALID_PARAMETER") 

expect("SetEndOfFile %s 41" % name, 0)
...
expect("GetFileInformation %s" % name, lambda r: r[0]["FileSize"] == 41)
